...
import * as esc from '../../escode/index'
...
import { ESComponent, __source } from '../../../spec';
...
export class Editor extends LitElement {
  ...
  static get styles() {
    ...
    setComponent = (config: any = {}, ui = !this.bind) => {
      ...
      const component = ((config.hasOwnProperty(specialKeys.isGraphScript)) ? config : this.createComponent(config)) as ESComponent
