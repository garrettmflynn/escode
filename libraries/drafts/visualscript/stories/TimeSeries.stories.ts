...
import { TimeSeries, TimeSeriesProps } from '../src/components/streams/data/TimeSeries';
...
const Template: Story<Partial<TimeSeriesProps>> = (args:any) => new TimeSeries(args);
